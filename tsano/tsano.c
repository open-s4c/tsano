...
void __tsan_read1_pc(void *a, void *b) { }
void __tsan_read2_pc(void *a, void *b) { }
void __tsan_read4_pc(void *a, void *b) { }
void __tsan_read8_pc(void *a, void *b) { }
void __tsan_read16_pc(void *a, void *b) { }
void __tsan_write1_pc(void *a, void *b) { }
void __tsan_write2_pc(void *a, void *b) { }
void __tsan_write4_pc(void *a, void *b) { }
void __tsan_write8_pc(void *a, void *b) { }
void __tsan_write16_pc(void *a, void *b) { }
...
int __tsan_atomic8_compare_exchange_strong(
        volatile uint8_t *a, uint8_t *c, uint8_t v, int mo) {
    return __atomic_compare_exchange_n(a, c, v, 0, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST);
}
int __tsan_atomic16_compare_exchange_strong(
        volatile uint16_t *a, uint16_t *c, uint16_t v, int mo) {
    return __atomic_compare_exchange_n(a, c, v, 0, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST);
}
int __tsan_atomic32_compare_exchange_strong(
        volatile uint32_t *a, uint32_t *c, uint32_t v, int mo) {
    return __atomic_compare_exchange_n(a, c, v, 0, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST);
}
int __tsan_atomic64_compare_exchange_strong(
        volatile uint64_t *a, uint64_t *c, uint64_t v, int mo) {
    return __atomic_compare_exchange_n(a, c, v, 0, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST);
}
int __tsan_atomic8_compare_exchange_weak(
        volatile uint8_t *a, uint8_t *c, uint8_t v, int mo) {
    return __atomic_compare_exchange_n(a, c, v, 1, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST);
}
int __tsan_atomic16_compare_exchange_weak(
        volatile uint16_t *a, uint16_t *c, uint16_t v, int mo) {
    return __atomic_compare_exchange_n(a, c, v, 1, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST);
}
...
int __tsan_atomic64_compare_exchange_weak(
        volatile uint64_t *a, uint64_t *c, uint64_t v, int mo) {
    return __atomic_compare_exchange_n(a, c, v, 1, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST);
}

/* compare_exchange_val */
uint8_t __tsan_atomic8_compare_exchange_val(volatile uint8_t *a, uint8_t c, uint8_t v, int mo) {
    (void)__atomic_compare_exchange_n(a, &c, v, 0, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST);
    return c;
}
uint16_t __tsan_atomic16_compare_exchange_val(volatile uint16_t *a, uint16_t c, uint16_t v, int mo) {
    (void)__atomic_compare_exchange_n(a, &c, v, 0, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST);
    return c;
}
uint32_t __tsan_atomic32_compare_exchange_val(volatile uint32_t *a, uint32_t c, uint32_t v, int mo) {
    (void)__atomic_compare_exchange_n(a, &c, v, 0, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST);
    return c;
}
uint64_t __tsan_atomic64_compare_exchange_val(volatile uint64_t *a, uint64_t c, uint64_t v, int mo) {
    (void)__atomic_compare_exchange_n(a, &c, v, 0, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST);
    return c;
}
