...
enum pthread_events {
    ...
    EVENT_RWLOCK_RDLOCK      = 10 + _EVENT_START,
    EVENT_RWLOCK_TIMEDRDLOCK = 11 + _EVENT_START,
    EVENT_RWLOCK_TRYRDLOCK   = 12 + _EVENT_START,
    EVENT_RWLOCK_WRLOCK      = 13 + _EVENT_START,
    EVENT_RWLOCK_TIMEDWRLOCK = 14 + _EVENT_START,
    EVENT_RWLOCK_TRYWRLOCK   = 15 + _EVENT_START,
    EVENT_RWLOCK_UNLOCK      = 16 + _EVENT_START,
};
#undef _EVENT_START
